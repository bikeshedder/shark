...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    list_display = ('number', 'get_customer', 'get_address', 'net', 'gross', 'created', 'paid', 'is_okay')
    list_editable = ('paid',)
    ...
    def get_address(self, invoice):
        return u'<br/>'.join(map(escape, invoice.address_lines))
