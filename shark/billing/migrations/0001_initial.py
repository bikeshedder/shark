    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sender', shark.utils.fields.AddressField(default=b"settings.SHARK['INVOICE']['SENDER']", blank=True)),
                ('recipient', shark.utils.fields.AddressField(help_text='This field will be automatically filled with the address of the customer.', blank=True)),
