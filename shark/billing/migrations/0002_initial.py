...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='invoiceitem',
            name='invoice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='item_set', to='billing.invoice', verbose_name='invoice'),
        ),
        migrations.AddField(
            model_name='invoice',
            name='customer',
