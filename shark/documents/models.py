...
class Document(models.Model):
    ...
    received = models.DateField(
        _("received"), default=today, help_text="Date when the document was received."
    )
    ...
    thumbnail_small = models.ImageField(upload_to="documents", editable=False)
    thumbnail_medium = models.ImageField(upload_to="documents", editable=False)
    thumbnail_large = models.ImageField(upload_to="documents", editable=False)
...
def document_pre_save(instance, raw, **kwargs):
    ...
    instance._file_changed = (
        not instance.pk or Document.objects.get(pk=instance.pk).file != instance.file
    )
