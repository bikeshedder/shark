    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(related_name='direct_debit_mandate_set', verbose_name='customer', to=get_model_name('customer.Customer'))),
                ('document', models.ForeignKey(verbose_name='signed document', blank=True, to='documents.Document', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('batch', models.ForeignKey(verbose_name='SEPA DD batch', to='sepa.DirectDebitBatch')),
                ('customer', models.ForeignKey(related_name='direct_debit_transaction_set', verbose_name='customer', to=get_model_name('customer.Customer'))),
                ('invoice', models.ForeignKey(verbose_name='invoice', blank=True, to='billing.Invoice', null=True)),
                ('mandate', models.ForeignKey(verbose_name=b'SEPA DD mandate', to='sepa.DirectDebitMandate')),
            ],
            options={
            },
            bases=(models.Model,),
