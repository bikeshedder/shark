...
class Issue(models.Model):
    project = models.ForeignKey(
        "project.Project", verbose_name=_("project"), on_delete=models.CASCADE
    )
...
class Relation(models.Model):
    a = models.ForeignKey(
        "issue.Issue", related_name="related_b_set", on_delete=models.CASCADE
    )
    b = models.ForeignKey(
        "issue.Issue", related_name="related_a_set", on_delete=models.CASCADE
    )
...
class Participant(models.Model):
    issue = models.ForeignKey(
        "issue.Issue", verbose_name=_("issue"), on_delete=models.CASCADE
    )
...
class Note(models.Model):
    issue = models.ForeignKey(
        "issue.Issue", verbose_name=_("note"), on_delete=models.CASCADE
    )
    author = models.ForeignKey(
        "auth.User", verbose_name=_("author"), on_delete=models.CASCADE
    )
...
class Attachment(models.Model):
    note = models.ForeignKey(
        "issue.Note", verbose_name=_("note"), on_delete=models.CASCADE
    )
